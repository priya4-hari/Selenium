...
public class Testing4 {
	...
	public static void main(String[] args)
	{
		...
		WebElement ele2 = driver.findElement(By.xpath("(//iframe[@src='SingleFrame.html'])[1]"));
		driver.switchTo().frame(ele2);
		driver.findElement(By.xpath("(//div[@class='col-xs-6 col-xs-offset-5'])[1]/input")).sendKeys("WELCOME WORLD!");
